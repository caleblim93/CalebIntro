...
def main(news,soup):
    if news.lower() == 'main':
        ...
        return format_titles_links(top_featured,top_links)
...
def society_news(soup):
    ...
    return format_titles_links(society_titles,society_links)
...
def disaster_news(soup):
    ...
    return format_titles_links(disaster_titles,disaster_links)
...
def political_news(soup):
    ...
    return format_titles_links(politic_titles,politic_links)
...
def business_news(soup):
    ...
    return format_titles_links(business_titles,business_links)
...
def international_news(soup):
    ...
    return format_titles_links(international_titles,international_links)
...
def science_culture_news(soup):
    ...
    return format_titles_links(snc_titles,snc_links)
...
def sports_news(soup):
    ...
    return format_titles_links(sports_titles,sports_links)
...
def medic_life_news(soup):
    ...
    return format_titles_links(medic_life_titles,medic_life_links)

def format_titles_links(titles,links):
    data = zip(titles,links)
    return data

def get_all_zipped_data(soup):
    all_news = {
        'main_news': main('main',soup),
        'featured_news': main('featured',soup),
        'society_news': main('society',soup),
        'disaster_news': main('disaster',soup),
        'political_news': main('politics',soup),
        'business_news': main('business',soup),
        'international_news': main('international',soup),
        'science_news': main('science',soup),
        'sports_news': main('sports',soup),
        'life_news': main('life', soup),
    }
    return all_news
...
def runner(version):
    soup = start_driver()
    if(version == 'jp'):
        return get_all_zipped_data(soup)
    else:
        return get_all_zipped_data(soup)
